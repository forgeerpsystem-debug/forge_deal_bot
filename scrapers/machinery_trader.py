...
def scrape_machinery_trader(keyword="skid steer"):
    print(f"🚜 Initiating MachineryTrader Hunt for: '{keyword}'...")
    search_term = keyword.replace(" ", "+")
    url = f"https://www.machinerytrader.com/search?SearchText={search_term}"
    ...
    with sync_playwright() as p:
        ...
        print("⏳ Waiting for MachineryTrader to load...")
        try:
    ...
    if not listing_links:
        print("⚠️ No MachineryTrader listings found. They might be blocking bots today.")
        return
    ...
    for link in listing_links:
        try:
            ...
            if not href.startswith("http"):
                href = "https://www.machinerytrader.com" + href
    ...
    print(f"🏁 MachineryTrader scraping complete. {success_count} new listings sent to the Forge Database.")

if __name__ == "__main__":
    scrape_machinery_trader("skid steer")
